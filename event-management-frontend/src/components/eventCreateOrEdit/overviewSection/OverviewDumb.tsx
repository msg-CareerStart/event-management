    ...
    <div className={overviewClasses.fundal}>
      ...
      <Grid container direction="column" justify="center" alignItems="center">
        <Grid item container direction="row" justify="center" alignItems="center">
          {createTextField(
            overviewClasses.root,
            props.handleEnterKey,
            props.isAdmin,
            'title',
            t('welcome.overviewTitle'),
            props.handleChange,
            props.event.title,
          ...
          {createTextField(
            ...
            props.isAdmin,
            'subtitle',
            t('welcome.overviewSubtitle'),
            props.handleChange,
            props.event.subtitle,
            props.formErrors.subtitle,
            'string',
            null
          )}
          ...
          {createTextField(
            ...
            props.handleChange,
            props.event.maxPeople,
            props.formErrors.maxPeople,
            'number',
            { inputProps: { min: 0 } }
          )}
        </Grid>
